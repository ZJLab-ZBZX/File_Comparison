...
//const {lexer} = require('katex/src/Lexer')
//const {Settings} = require('katex/src/Settings')
//var path = require('path');
//var lexer = require(path.join(__dirname,"node_modules/katex/src/Parser.js"))
...
//            console.log(lexer(line,settings).tokens);
//            var tree = katex.__parse(" \\begin{align} H_R^{\\cal K}(A,q) = \\sum_{X\\in {\\cal R}_R} Z_R^X(A,q) F_X^{\\cal K}(A,q) \\end{align}", {displayMode: true});
//            console.log(tree)
//            console.log(tree.lexer)
